...
training_data_set.append({"tweet_id": row[0], "text": row[1], "label":
...
if classified_result_labels.count('positive') >=
classified_result_labels.count('negative'):
print("Overall positive sentiment")
print("Positive Sentiment Percentage = " +
str((classified_result_labels.count('positive') /

len(classified_result_labels) * 100)) + "%")
else:
print("Overall negative sentiment")
print("Negative Sentiment Percentage = " +
str((classified_result_labels.count('negative') /
